...
direct_cuda_pattern: src/direct_cuda_pattern.cc
	...
	$(CUDACXX64) src/cuda_pattern.cu -o $(OBJECTS_DIR)/_cuda_pattern.o $(INCPATH) -m64 -dc -gencode arch=compute_35,code=sm_35 --relocatable-device-code true  -Xptxas -v
