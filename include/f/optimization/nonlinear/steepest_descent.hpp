...
namespace f
{
    ...
    struct simple_steepest_descent : default_steepest_descent< T, simple_steepest_descent<T> >
    {
        ...
        template< typename Function >
        simple_steepest_descent( Function const& func_, size_type len_, size_type loop_ = 1000 ) : default_steepest_descent< T, simple_steepest_descent<T> >( func_, len_, loop_ ) {}
